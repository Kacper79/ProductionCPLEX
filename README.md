...
Artykul opisuje bazowy model CLSP-RM-SS realizujący problem produkcyjny - *multi-product lot-sizing problem with product returns and remanufacturing subject to a capacity constraint* oraz przedstawia różne warianty modeli produkcyjnych.
